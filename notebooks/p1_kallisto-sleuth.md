...
def process_sleuth_transcripts(experiment):
    ...
    sleuth_diff.to_hdf("../data/processed/kallisto_sleuth_merge/"+experiment+"_transcripts.h5",key="sleuth_diff",mode="w")
```
...
def process_sleuth_genes(experiment):
    ...
    sleuth_diff.to_hdf("../data/processed/kallisto_sleuth_merge/"+experiment+"_genes.h5",key="sleuth_diff",mode="w")
```
