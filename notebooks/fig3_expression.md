...
```python
qval_mat = merged_top_gsea[["signed_qval","gene_set","experiment"]].pivot(index="gene_set",columns="experiment")
...
```python
sns.set_style("whitegrid", {'grid.linestyle': '--', 'xtick.bottom': True,'ytick.left': True})
